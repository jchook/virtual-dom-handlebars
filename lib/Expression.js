...
Expression.prototype.toJavascript = function(yield) {
	...
	return [ 'env.callHelper(', JSON.stringify(this.helper), ',', this.isPartial ? JSON.stringify(this.partialName) + ',' : '', this.context.toJavascript(), ',{', this.args, '}', (yield ? ',' + yield.toJavascript() : ''), ', this)' ].join('');
}