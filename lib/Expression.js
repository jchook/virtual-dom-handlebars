...
Expression.prototype.toJavascript = function(callback) {
	...
	return [ 'env.callHelper(', JSON.stringify(this.helper), ',', this.isPartial ? JSON.stringify(this.partialName) + ',' : '', this.context.toJavascript(), ',{', this.args, '}', (callback ? ',' + callback.toJavascript() : ',null'), ',this)' ].join('');
}