...
Basic strategy:
	...
	* Parse the html
		* When you reach text with the snip marker, parse the handlebars block
			...
			* the result of the block parser is a string representing a javascript closure that returns an array of VNodes
